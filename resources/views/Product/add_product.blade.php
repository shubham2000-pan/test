              ...
              <form action="{{url('Product_store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" name="Qty" class="form-control" id="exampleInputAbout" placeholder="Enter About">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputAbout">Price</label>
                    <input type="text" name="Price" class="form-control" id="exampleInputAbout" placeholder="Enter About">
                  </div>
